...
sh_ver="1.3.2"
github="raw.githubusercontent.com/fyfh/Linux-NetSpeed-fix/master"
...
installbbr(){
	...
	if [[ "${release}" == "centos" ]]; then
		...
		mkdir bbr && cd bbr
		wget -N --no-check-certificate http://${github}/bbr/debian-ubuntu/libssl1.0.0_1.0.1t-1+deb8u10_amd64.deb
